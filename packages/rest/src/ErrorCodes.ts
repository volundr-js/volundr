/** Discord REST API JSON error codes. */
export const RESTJSONErrorCodes = {
    GeneralError: 0,
    ...
    UserIsBannedFromThisGuild: 40007,
    ...
    TagIsRequiredToCreateAForumPostInThisChannel: 40067,
    ...
    TriedToPerformAnOperationOnAnArchivedThread: 50083,
    ...
    YouDoNotHavePermissionToSendThisStickerInThisChannel: 50600,
...
export type RESTJSONErrorCode = (typeof RESTJSONErrorCodes)[keyof typeof RESTJSONErrorCodes];
